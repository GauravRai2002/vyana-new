...
function SingleTestimonial({icon,review,name}) {
    return (
        <>
            <div className="card card-side glass width shadow-xl md:h-64 h-fit">
                <div className="avatar flex items-start justify-center m-3">
                    <div className="md:w-24 w-16 md:h-24 h-16 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                        <img className='aspect-square' src={icon} />
                    </div>
                </div>
                <div className="md:p-8 p-2 text-white">
                    <h2 className="card-title font-extrabold md:text-3xl text-xl">{name}</h2>
                    <p className=''>                        
