            ...
            <div className="card flex-wrap card-side shadow-xl md:w-5/6 w-full px-1 md:mx-auto my-16 relative">
                <div className='w-full'>
                    <Slider className='rounded-lg'  {...settings}>
                        <img className='brightness-50 rounded-lg md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698831990/Services/liveStream/_41A0813_ufjiqc.jpg' alt="" />
                        <img className='brightness-50 rounded-lg  md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698832013/Services/liveStream/1H1A6730_nb4tch.jpg' alt="" />
                        <img className='brightness-50 rounded-lg md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698831969/Services/liveStream/_41A0816_owyl6n.jpg' alt="" />
                    </Slider>
                </div>
