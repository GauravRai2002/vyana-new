            ...
            <div className="card flex-wrap card-side shadow-xl md:w-5/6 w-full px-1 md:mx-auto my-16 relative">
                <div className='w-full'>
                    <Slider className='rounded-lg'  {...settings}>
                        <img className=' rounded-lg  md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698832556/Services/Scoring/1H1A6490_cjf7tr.jpg' alt="" />
                        <img className=' rounded-lg md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698832478/Services/Scoring/1H1A6232_jsueu6.jpg' alt="" />
                        <img className=' rounded-lg md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698832298/Services/Scoring/_41A1033_twctoh.jpg' alt="" />
                        <img className=' rounded-lg md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698832436/Services/Scoring/IMG_9649_ykdekc.jpg' alt="" />
                    </Slider>
                </div>
