            ...
            <div className="card flex-wrap card-side shadow-xl md:w-5/6 w-full px-1 md:mx-auto my-16 relative">
                <div className='w-full'>
                    <Slider className='rounded-lg'  {...settings}>
                        <img className=' rounded-lg  md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698828974/Services/Auction/CRI_1075_ybm1ow.jpg' alt="" />
                        <img className=' rounded-lg md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698828974/Services/Auction/CRI_1172_mdkfnj.jpg' alt="" />
                        <img className=' rounded-lg md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698828974/Services/Auction/CRI_1144_lgeprt.jpg' alt="" />
                        <img className=' rounded-lg md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698828977/Services/Auction/CRI_1104_xxtseq.jpg' alt="" />
                        <img className=' rounded-lg md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698828977/Services/Auction/CRI_1066_ourxxi.jpg' alt="" />
                        <img className=' rounded-lg md:h-[95vh]' src='https://res.cloudinary.com/dy4rzochf/image/upload/v1698828977/Services/Auction/CRI_1045_nrzoht.jpg' alt="" />
                    </Slider>
                </div>
